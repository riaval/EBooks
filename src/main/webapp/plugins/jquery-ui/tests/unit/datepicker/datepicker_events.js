...
test("events", function() {
	...
	equal(selectedDate, "2007/1", "Callback change month/year date - setPublicationDate");
	selectedDate = null;
	inp.datepicker("setDate", new Date(2007, 1 - 1, 12));
	ok(selectedDate == null, "Callback change month/year date - setPublicationDate no change");
...
test("beforeShowDay-getPublicationDate", function() {
	expect( 3 );
