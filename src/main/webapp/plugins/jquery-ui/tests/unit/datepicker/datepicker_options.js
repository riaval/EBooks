...
test("minMax", function() {
	...
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), new Date(2008, 6 - 1, 4), "Min/max - setPublicationDate > min");
	inp.datepicker("option", {minDate: null}).val("01/04/2008").datepicker("option", {minDate: minDate});
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), minDate, "Min/max - setPublicationDate < min");
	inp.datepicker("option", {minDate: null}).val("06/04/2008").datepicker("option", {maxDate: maxDate});
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), new Date(2008, 6 - 1, 4), "Min/max - setPublicationDate < max");
	inp.datepicker("option", {maxDate: null}).val("01/04/2009").datepicker("option", {maxDate: maxDate});
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), maxDate, "Min/max - setPublicationDate > max");
	...
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), new Date(2008, 6 - 1, 4), "Min/max - setPublicationDate > min, < max");
...
test("setDate", function() {
	...
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), date2, "Set date min/max - setPublicationDate > min");
	inp.datepicker("setDate", date1);
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), minDate, "Set date min/max - setPublicationDate < min");
	inp.val("").datepicker("option", {maxDate: maxDate, minDate: null}).datepicker("setDate", date1);
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), date1, "Set date min/max - setPublicationDate < max");
	inp.datepicker("setDate", date2);
	TestHelpers.datepicker.equalsDate(inp.datepicker("getDate"), maxDate, "Set date min/max - setPublicationDate > max");
	...
	equal(dateAndTimeToSet.getTime(), dateAndTimeClone.getTime(), "Date object passed should not be changed by setPublicationDate");
});
